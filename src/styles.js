const styles = {
    ...
    heroSubText:
      "text-[#dfd9ff] font-medium lg:text-[29px] sm:text-[22px] xs:text-[10px] text-[16px] lg:leading-[40px]",
  
    sectionHeadText:
      "text-white font-black md:text-[70px] sm:text-[50px] xs:text-[40px] text-[30px]",
    sectionSubText:
      "sm:text-[18px] text-[29px] text-secondary uppercase tracking-wider",
  };
